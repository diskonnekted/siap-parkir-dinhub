...
<table cellpadding="2px" cellspacing="2px">
	...
	<tr>
		...
		<td valign="top">:</td>
		<td align="justify">
			Pengelola Parkir <?php echo $row->jenis_lokasi?> wilayah <?php echo $row->zona?> ( <?php echo $row->nama_lokasi?> ), berkedudukan di <?php echo $row->domisili_alamat?> RT <?php echo $row->domisili_rt?> RW <?php echo $row->domisili_rw?> <?php echo $row->desa?>, Kecamatan <?php echo $row->kec?> <?php echo $row->kab?>, dalam hal ini bertindak dan atas nama serta sah sebagai Pengelola Parkir <?php echo $row->jenis_lokasi?>  <?php echo $row->zona?> ( <?php echo $row->nama_lokasi?> ) Kabupaten Banjarnegara selanjutnya disebut PIHAK KEDUA.
		</td>
	</tr>
</table>
<br>
...
<p align="justify">
	<ol>
		...
		<ol type="a">
			...
			<li>Memberikan Ganti Rugi atas kehilangan Kendaraan termasuk kelengkapannya dan/atau kerusakan yang dialami karena kesengajaan atau kealpaan Juru Parkir;</li>
...
<ol>
	<li>
		...
		<ol type="a">
			...
			<li>
				Pengelola Parkir di <?php echo $row->jenis_lokasi?> <?php echo $row->zona?> ( <?php echo $row->nama_lokasi?> ) Kabupaten Banjarnegara, yang beralamat di <?php echo $row->domisili_alamat?> RT <?php echo $row->domisili_rt?> RW <?php echo $row->domisili_rw?> <?php echo $row->desa?>, Kecamatan <?php echo $row->kec?> <?php echo $row->kab?>.
			</li>
		</ol>
	</li>
</ol>
...
<table>
	...
	<tr>
		<td align="center" valign="top">
			...
			<br>
			<br>
			<u><?php echo strtoupper($row->nama)?></u>
		</td>
		<td></td>
		<td align="center" valign="top">
			PIHAK KESATU<br>
